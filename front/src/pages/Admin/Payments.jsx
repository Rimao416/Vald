...
import { fetchAcademicPayment, getMyAcademicPayments } from "../../redux/slice/paymentSlice";
function Payments() {
  ...
  useEffect(() => {
    dispatch(fetchAcademicPayment()).then((res) => {
      console.log(res);
    });
  }, [dispatch]);
  ...
  return (
    <MainLayout>
      <DataTableHeader buttonText="paiements" handleFilter={handleFilter} />
